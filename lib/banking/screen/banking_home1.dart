...
import 'package:fintech/banking/utils/banking_data_generator.dart';
...
class BankingHome1State extends State<BankingHome1> {
  ...
  int? pageLength;
  var name = 'Cosmas Ken'.obs;
  var loanname = 'Loan Account'.obs;
  var mainbalance= 40000.obs;
  var loanbalance= 90000.obs;
                          ...
                          Container(
                            ...
                            child: PageView(
                              children: [
                                ...
                                TopCard(name: "$name", acno: "9874563210", bal: "$mainbalance"),
                                TopCard(name: "$name", acno: "5821479630", bal: "$loanbalance"),
                              ],
                              onPageChanged: (value) {
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text("29 Sep 2021", style: primaryTextStyle(size: 16, color: Banking_TextColorSecondary, fontFamily: fontRegular)),
                  ],
                ),
                ListView.builder(
