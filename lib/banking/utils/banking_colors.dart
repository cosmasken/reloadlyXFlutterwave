...
const Banking_purpleColor = Color(0xFFAD3AC3);
 ...
 const Color lightColor = Color.fromRGBO(252, 223, 228, 1);
 const Color lighterColor = Color.fromRGBO(254, 248, 240, 1);
 Color secondaryColor = Color(0xFFF9F6FF);
 Color accentColor = Color(0xFF5DC379);
 Color yellowLightColor = Color(0xFFFDF5E6);
 Color redDarkColor = Color(0xFF2B0100);
 Color redColor = Color(0xFFD90404);
 Color greyColor = Color(0xFF707070);
 Color greenColor = Color(0xFF03A60F);
 Color greenLightColor = Color(0xFFE5F6E7);
 Color blueColor = Color(0xFF307AFF);
